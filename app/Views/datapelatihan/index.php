...
<a class="btn btn-primary" href="<?= base_url('/datapelatihan/create'); ?>"><i class="fas fa-plus mr-2"></i>Tambah Pelatihan</a>
<br>
<br>
...
<table class="table table-bordered">
  ...
  <tr>
    ...
    <td scope="col"><form action="/datapelatihan/<?= $l['id']; ?>" method="post">
                              <?= csrf_field(); ?>
                              <input type="hidden" name="_method" value="delete">
                              <button type="submit" class="badge badge-danger text-white" onclick="return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></button>
                    </form></td>
  </tr>
  <?php endforeach; ?>
